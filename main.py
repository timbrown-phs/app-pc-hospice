...
def set_access_token(token):
    ...
    print('set', dir(st.session_state['access_token']))

def get_access_token():
    print('get_access_token')
    print('get',dir(st.session_state))
...
def main():
    ...
    with st.sidebar:
        ...
        # st.image('PredictaCare.jpg', use_column_width=False)
        # st.image('hospice.jpg', use_column_width=False)
        ...
        if st.button('Run Hospice Prediction', use_container_width=True):
            ...
            res = insert_log_user_activity(conn, user.email, 'Predict')
            print(res)
